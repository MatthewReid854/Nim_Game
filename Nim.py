...
def create_operation_buttons():
    ...
    Start = Button(operation_frame, text='Click here to start a new game', height=2, command=start_game, bg='white',fg='purple')
    Start.pack(fill="both", expand=True, side=LEFT)
    Rules = Button(operation_frame, text='Click here to see the rules', command=show_rules, height=2, bg='purple',fg='white')
